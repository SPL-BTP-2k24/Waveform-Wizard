...
Download the latest installation files from [Releases](https://github.com/SPL-BTP-2k24/Waveform-Wizard-Public/releases) Page.
...
1. Download the latest installation file from [Releases](https://github.com/SPL-BTP-2k24/Waveform-Wizard-Public/releases) Page.
...
1. Download the latest installation file from [Releases](https://github.com/SPL-BTP-2k24/Waveform-Wizard-Public/releases) Page. Available for:
...
Visit [Report](https://github.com/SPL-BTP-2k24/Waveform-Wizard-Public/blob/master/Report.pdf) for step by step help in using the application.

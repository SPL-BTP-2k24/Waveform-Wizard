...
from PyQt5.QtWidgets import (QAction, QDialog, QFileDialog, QGroupBox,
                             QHBoxLayout, QLabel, QMainWindow, QMenu,
                             QMessageBox, QToolBar, QToolButton, QVBoxLayout,
                             QWidget)
from utils import (get_file_extension, has_second_channel, process_audio,
                   show_message)
